...
public class GameLogic : MonoBehaviour {
	...
	public void roundReset() {
		...
		/*okBtn2.GetComponentInChildren<CanvasRenderer>().SetAlpha(1);
		okBtn2.GetComponentInChildren<Text>().color = Color.black;*/

		trail.material.SetColor("TrailColor",new Color(0.0f,0.5f,0.6f,0.0f));

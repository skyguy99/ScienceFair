...
*/
	...
	{
		if (UIManagerScript.roundNum == 1) {
			completes.transform.localPosition = new Vector2(completes.transform.localPosition.x, (completes.transform.localPosition.y)-0.65f);

		}
		else if (UIManagerScript.roundNum == 2) {
			completes.transform.localPosition = new Vector2(completes.transform.localPosition.x, (completes.transform.localPosition.y)-0.6f);
			...
			completes.transform.localPosition = new Vector2(completes.transform.localPosition.x, (completes.transform.localPosition.y));
		}
	}
	...
	void Update () {
		...
		Debug.Log (completes.transform.localPosition);

   ...
   public class UILineRenderer : MaskableGraphic
    {
		...
		public UILineRenderer mazeliner;
		...
		void updateLine()
		{
			...
			mazeliner.Points.SetValue (new Vector2 (8, 1), 0);
			mazeliner.Points.SetValue (new Vector2 (9, 0), 1);
			mazeliner.Points.SetValue (new Vector2 (5, 3), 2);
		...
		void Update()
		{
			...
			//UILineRenderer.Points.SetValue (new Vector2 (0, 1), 0);
			//Points[2] = new Vector2(0,7);
			updateLine();
